> [Specification Website](https://cs50.harvard.edu/x/2024/psets/4/filter/more)
...
$ ./filter -g ./images/stadium.bmp ./images/stadium-reflected.bmp
$ ./filter -g ./images/tower.bmp ./images/tower-blurred.bmp
$ ./filter -g ./images/yard.bmp ./images/yard-edges.bmp
$ ./filter
...
unzip filter-more.zip && rm filter-more.zip && cd filter-more
```
