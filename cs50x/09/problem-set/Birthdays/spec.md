...
![screenshot of birthdays website](./assets/birthdays.png)
...
```sh
wget https://cdn.cs50.net/2023/fall/psets/9/birthdays.zip && unzip birthdays.zip && rm -f birthdays.zip && cd birthdays
```
