...
![C$50 Finance](./assets/finance_2024.png)
...
```
wget https://cdn.cs50.net/2024/x/psets/9/finance.zip && unzip finance.zip && rm -f finance.zip && cd finance
```
### Running
...
-   To format a value as a US dollar value (with cents listed to two decimal places), you can use the `usd` filter in your Jinja templates (printing values as `{}` instead of `{}`.
